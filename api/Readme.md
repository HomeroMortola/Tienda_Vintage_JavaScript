...
| Creación de reclamos y reembolsos | Reclamos | `topic_claims_integration_wh` | [Checkout API](/developers/es/docs/checkout-api-orders/overview)<br>[Checkout Pro](/developers/es/docs/checkout-pro/overview)<br>[Checkout Bricks](/developers/es/docs/checkout-bricks/overview)<br>[Suscripciones](/developers/es/docs/subscriptions/overview)<br>[Mercado Pago Point](/developers/es/docs/mp-point/landing)<br>[Código QR](/developers/es/docs/qr-code/overview)<br>[Wallet Connect](/developers/es/docs/wallet-connect/landing) |
...
| Finalización, cancelación o errores al procesar intenciones de pago de dispositivos [Mercado Pago Point](/developers/es/docs/mp-point/landing). | Integraciones Point | `point_integration_wh` | [Mercado Pago Point](/developers/es/docs/mp-point-legacy/overview) (**legacy**) | 
...
> Importante
> 
> Las notificaciones de [Código QR](/developers/es/docs/qr-code/overview) no pueden ser validadas utilizando la clave secreta, por eso deberás continuar directamente con la etapa “Simular el recibimiento de una notificación”. Para verificar el origen de las notificaciones de integraciones con [Código QR](/developers/es/docs/qr-code/overview), entra en contacto con [Soporte de Mercado Pago](https://www.mercadopago[FAKER][URL][DOMAIN]/developers/es/support/center).
...
| --- | --- | --- |
| order | `https://api.mercadopago.com/v1/orders/{id}` | [Obtener order por ID](/developers/es/reference/online-payments/checkout-api/get-order/get) (para [Checkout API](/developers/es/docs/checkout-api-orders/overview)) |
| order | `https://api.mercadopago.com/v1/orders/{order_id}` | [Obtener order por ID](/developers/es/reference/in-person-payments/point/orders/get-order/get) (para [Mercado Pago Point](/developers/es/docs/mp-point/overview)) |
| order | `https://api.mercadopago.com/v1/orders/{order_id}` | [Obtener order por ID](/developers/es/reference/in-person-payments/qr-code/orders/get-order/get) (para [Código QR](/developers/es/docs/qr-code/overview)) |
| payment | `https://api.mercadopago.com/v1/payments/[ID]` | Obtener pago para [Checkout API](/developers/es/reference/online-payments/checkout-api-payments/get-payment/get), [Checkout Pro](/developers/es/reference/online-payments/checkout-pro/get-payment/get) o [Suscripciones](/developers/es/reference/online-payments/subscriptions/get-payment/get) |
| subscription_preapproval | `https://api.mercadopago.com/preapproval/search` | [Obtener suscripción](/developers/es/reference/online-payments/subscriptions/search-preapproval/get) |
| subscription_preapproval_plan | `https://api.mercadopago.com/preapproval_plan/search` | [Obtener plan de suscripción](/developers/es/reference/online-payments/subscriptions/search-preapproval-plan/get) |
| subscription_authorized_payment | `https://api.mercadopago.com/authorized_payments/[ID]` | [Obtener información de facturas](/developers/es/reference/online-payments/subscriptions/get-authorized-payment/get) |
...
| topic_merchant_order_wh | `https://api.mercadopago.com/merchant_orders/[ID]` | [Obtener orden comercial para Checkout Pro](/developers/es/reference/online-payments/checkout-pro/merchant_orders/get-merchant-order/get) o para [Código QR (deprecado)]()|
| topic_chargebacks_wh | `https://api.mercadopago.com/v1/chargebacks/[ID]` | [Obtener contracargo](/developers/es/reference/online-payments/checkout-pro/get-chargeback/get) |
...
![panel de notificaciones webhooks](/images/dashboard/notification-dashboard-es-v1.png)
...
![detalles de notificaciones enviadas](/images/dashboard/notification-details-dashboard-es-v1.png)
