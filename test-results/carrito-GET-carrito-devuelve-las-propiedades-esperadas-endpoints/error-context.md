...
- Name: carrito.spec.js >> GET /carrito >> devuelve las propiedades esperadas
- Location: tests-e2e\carrito.spec.js:20:5
...
Received value: {"error": "Error al obtener carrito"}
```
